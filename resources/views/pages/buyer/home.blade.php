...
@section('content')
    ...
    <!-- Reduced background gradient intensity to 10% opacity for a milder tone -->
    <div x-data="{ modalOpen: false, activeProduct: null }" class="bg-gradient-to-b from-white to-[#F30399]/10 font-sans antialiased text-text-main overflow-x-hidden min-h-screen">
        
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 animate-fade-in-up">
            
            <!-- Hero Banner -->
            <div class="relative bg-cover bg-center rounded-3xl overflow-hidden mb-12 shadow-sm border border-border-subtle h-[350px] flex items-center" style="background-image: url('{{ asset('assets/yeezy-preview.png') }}');">
                ...
                <div class="relative z-10 p-10 md:p-16 w-full md:w-2/3">
                    ...
                    <a href="#" class="inline-flex px-8 py-3 bg-[#F30399] hover:bg-[#d10283] text-white font-bold rounded-full transition-colors duration-300 shadow-md relative z-30">
                        Shop Now
                    </a>
                </div>
            </div>
