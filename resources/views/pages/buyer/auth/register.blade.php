...
<body class="m-0 p-0 h-screen w-screen flex font-sans antialiased text-text-main overflow-hidden bg-surface">
    ...
    {{-- Right Panel: Register Form (100% width on Mobile, 50% width on Large Screens) --}}
    <div class="w-full lg:w-1/2 h-full flex flex-col items-center justify-start p-4 sm:p-8 lg:p-12 bg-gradient-to-br from-surface-subtle via-surface to-brand-light/30 overflow-y-auto rounded-scrollbar">
        
        {{-- Form Container --}}
        <div class="w-full max-w-2xl bg-surface/90 backdrop-blur-sm p-6 sm:p-8 rounded-2xl sm:rounded-[2rem] shadow-xl border border-border-subtle my-auto">
