            ...
            <form action="{{ route('login.post') }}" method="POST" class="space-y-5">
                ...
                <div>
                    ...
                    <div class="flex items-center w-full border-2 border-border-subtle rounded-xl bg-surface focus-within:border-primary focus-within:ring-1 focus-within:ring-primary transition-all overflow-hidden shadow-sm">
                        ...
                        <input type="email" id="email" name="email" class="w-full py-3 pr-4 bg-transparent outline-none text-text-main" placeholder="you@example.com" required>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="flex items-center w-full border-2 border-border-subtle rounded-xl bg-surface focus-within:border-primary focus-within:ring-1 focus-within:ring-primary transition-all overflow-hidden shadow-sm">
                        ...
                        <input type="password" id="password" name="password" class="w-full py-3 pr-4 bg-transparent outline-none text-text-main" placeholder="••••••••" required>
                    </div>
                </div>
