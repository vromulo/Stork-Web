<footer class="bg-surface-subtle border-t border-border-subtle font-sans pt-16 pb-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            ...
            <!-- Customer Care -->
            <div>
                <h3 class="text-sm font-bold text-text-main mb-4 uppercase tracking-wider">Customer Care</h3>
                <ul class="space-y-3">
                    <li><a href="#" class="text-sm text-text-muted hover:text-primary transition-colors">Help Center</a></li>
                    <li><a href="#" class="text-sm text-text-muted hover:text-primary transition-colors">Track Your Order</a></li>
                    <li><a href="#" class="text-sm text-text-muted hover:text-primary transition-colors">Returns & Refunds</a></li>
                    <li><a href="#" class="text-sm text-text-muted hover:text-primary transition-colors">Shipping Information</a></li>
                    <li><a href="#" class="text-sm text-text-muted hover:text-primary transition-colors">Contact Us</a></li>
                </ul>
            </div>

            <!-- Newsletter -->
            <div>
                <h3 class="text-sm font-bold text-text-main mb-4 uppercase tracking-wider">Stay in the Loop</h3>
                <p class="text-sm text-text-muted mb-4">Subscribe to our newsletter for exclusive deals, new arrivals, and insider-only discounts.</p>
                <form action="#" method="POST" class="flex flex-col space-y-3">
                    <div class="flex items-center w-full border-2 border-border-subtle rounded-xl bg-surface focus-within:border-primary focus-within:ring-1 focus-within:ring-primary transition-all overflow-hidden shadow-sm">
                        <input type="email" placeholder="Enter your email" required class="w-full py-2.5 px-4 bg-transparent outline-none text-text-main text-sm placeholder:text-text-muted">
                    </div>
                    <button type="submit" class="w-full py-2.5 px-4 bg-primary hover:bg-primary-dark text-surface text-sm font-bold rounded-xl shadow-md transition-colors">
                        Subscribe
                    </button>
                </form>
            </div>
