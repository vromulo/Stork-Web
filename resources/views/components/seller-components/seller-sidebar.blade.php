    ...
    <nav x-data="{ activeDropdown: '{{ request()->is('seller/products*') ? 'products' : (request()->is('seller/orders*') ? 'orders' : (request()->is('seller/promotions*') ? 'promotions' : (request()->is('seller/sales*') ? 'sales' : (request()->is('seller/account*') ? 'account' : null)))) }}' }" class="flex-1 overflow-y-auto overflow-x-hidden p-3 space-y-1.5 custom-scrollbar">
        ...
        <div>
            ...
            <div x-show="activeDropdown === 'orders' && sidebarOpen" x-collapse x-cloak class="pl-12 pr-4 py-2 space-y-3">
                ...
                <a href="#" class="block text-xs text-text-muted hover:text-primary transition-colors whitespace-nowrap cursor-pointer">New Orders</a>
                <a href="#" class="block text-xs text-text-muted hover:text-primary transition-colors whitespace-nowrap cursor-pointer">To Process</a>
                <a href="#" class="block text-xs text-text-muted hover:text-primary transition-colors whitespace-nowrap cursor-pointer">To Ship</a>
                <a href="#" class="block text-xs text-text-muted hover:text-primary transition-colors whitespace-nowrap cursor-pointer">Shipped</a>
        ...
        <div>
            ...
            <div x-show="activeDropdown === 'promotions' && sidebarOpen" x-collapse x-cloak class="pl-12 pr-4 py-2 space-y-3">
                ...
                <a href="#" class="block text-xs text-text-muted hover:text-primary transition-colors whitespace-nowrap cursor-pointer">Vouchers</a>
        ...
        <div>
            ...
            <div x-show="activeDropdown === 'sales' && sidebarOpen" x-collapse x-cloak class="pl-12 pr-4 py-2 space-y-3">
                ...
                <a href="#" class="block text-xs text-text-muted hover:text-primary transition-colors whitespace-nowrap cursor-pointer">Profit & Financial</a>
        ...
        <div>
            ...
            <div x-show="activeDropdown === 'account' && sidebarOpen" x-collapse x-cloak class="pl-12 pr-4 py-2 space-y-3">
                ...
                <a href="#" class="block text-xs text-text-muted hover:text-primary transition-colors whitespace-nowrap cursor-pointer">Personal Information</a>
                <a href="#" class="block text-xs text-text-muted hover:text-primary transition-colors whitespace-nowrap cursor-pointer">Payment / Payout</a>
                <a href="#" class="block text-xs text-text-muted hover:text-primary transition-colors whitespace-nowrap cursor-pointer">Security</a>
            </div>
        </div>
